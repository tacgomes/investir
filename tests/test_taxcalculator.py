...
def test_section_104_disposal():
    ...
    """
    order1 = Acquisition(
        datetime(2015, 4, 1), ticker='LOBS',
        quantity=Decimal('1000.0'),
        amount=Decimal('4000.0'),
        fees=Decimal('150.0'))

    order2 = Acquisition(
        datetime(2018, 9, 1), ticker='LOBS',
        quantity=Decimal('500.0'),
        amount=Decimal('2050.0'),
        fees=Decimal('80.0'))

    order3 = Disposal(
        datetime(2023, 5, 1), ticker='LOBS',
        quantity=Decimal('700.0'),
        amount=Decimal('3360.0'),
        fees=Decimal('100.0'))

    order4 = Disposal(
        datetime(2024, 2, 1), ticker='LOBS',
...
def test_section_104_with_no_disposal_made():
    order1 = Acquisition(
        datetime(2015, 4, 1), ticker='X',
        quantity=Decimal('1000.0'),
        amount=Decimal('4000.0'),
        fees=Decimal('150.0'))

    order2 = Acquisition(
        datetime(2018, 9, 1), ticker='X',
        quantity=Decimal('500.0'),
...
def test_same_day_rule():
    order1 = Acquisition(
        datetime(2018, 1, 1), ticker='X',
        quantity=Decimal('10.0'),
        amount=Decimal('100.0'))

    order2 = Disposal(
        datetime(2019, 1, 20, 14, 00), ticker='X',
        quantity=Decimal('1.0'),
        amount=Decimal('70.0'))

    order3 = Acquisition(
        datetime(2019, 1, 20, 15, 00), ticker='X',
        quantity=Decimal('1.0'),
        amount=Decimal('60.0'))

    order4 = Acquisition(
        datetime(2019, 1, 20, 16, 00), ticker='X',
        quantity=Decimal('2.0'),
        amount=Decimal('65.0'))

    order5 = Disposal(
        datetime(2019, 1, 20, 17, 00), ticker='X',
        quantity=Decimal('4.0'),
        amount=Decimal('280.0'))

    order6 = Acquisition(
        datetime(2019, 1, 20, 18, 00), ticker='X',
        quantity=Decimal('2.0'),
        amount=Decimal('55.0'))
...
def test_bed_and_breakfast_rule(days_elapsed):
    order1 = Acquisition(
        datetime(2019, 1, 18), ticker='X',
        quantity=Decimal('10.0'),
        amount=Decimal('100.0'))

    order2 = Disposal(
        datetime(2019, 1, 20), ticker='X',
        quantity=Decimal('5.0'),
        amount=Decimal('150.0'))

    order3 = Acquisition(
        order2.timestamp + timedelta(days=days_elapsed), ticker='X',
        quantity=Decimal('5.0'),
...
def test_acquisitions_are_not_matched_after_thirty_days_of_disposal_date():
    ...
    order2 = Disposal(
        datetime(2019, 1, 19), ticker='X',
        quantity=Decimal('5.0'),
        amount=Decimal('150.0'))

    order3 = Acquisition(
        datetime(2019, 2, 19), ticker='X',
        quantity=Decimal('5.0'),
        amount=Decimal('120.0'))
...
def test_matching_disposals_with_larger_acquisition():
    ...
    order3 = Disposal(
        datetime(2019, 1, 21), ticker='X',
        quantity=Decimal('1.0'),
        amount=Decimal('11.0'))

    order4 = Acquisition(
        datetime(2019, 1, 22), ticker='X',
...
def test_rppaccounts_example():
    ...
    order1 = Acquisition(
        datetime(2019, 1, 18), ticker='X',
        quantity=Decimal('4.0'), amount=Decimal('12025.0'))

    order2 = Disposal(
        datetime(2019, 1, 18), ticker='X',
        quantity=Decimal('3.0'), amount=Decimal('9100.0'))

    order3 = Disposal(
        datetime(2019, 1, 19), ticker='X',
        quantity=Decimal('1.0'), amount=Decimal('5000.0'))

    order4 = Acquisition(
        datetime(2019, 1, 22), ticker='X',
        quantity=Decimal('1.0'), amount=Decimal('2000.0'))

    order5 = Acquisition(
        datetime(2019, 1, 23), ticker='X',
        quantity=Decimal('5.0'), amount=Decimal('15000.0'))

    order6 = Disposal(
        datetime(2019, 1, 24), ticker='X',
        quantity=Decimal('2.0'), amount=Decimal('8000.0'))

    order7 = Acquisition(
        datetime(2019, 1, 25), ticker='X',
        quantity=Decimal('1.0'), amount=Decimal('3300.0'))

    order8 = Disposal(
        datetime(2019, 1, 25), ticker='X',
        quantity=Decimal('1.0'), amount=Decimal('3500.0'))

    order9 = Acquisition(
        datetime(2019, 1, 26), ticker='X',
        quantity=Decimal('4.0'), amount=Decimal('17000.0'))

    order10 = Disposal(
        datetime(2019, 1, 27), ticker='X',
        quantity=Decimal('8.0'), amount=Decimal('70000.0'))
